  ...
  return (
    <>
      ...
      <section className="relative bg-[#F0FBFF] pb-16 md:pb-24">
        ...
        <div className="w-full flex justify-center -mt-24 md:-mt-25 px-4 relative z-10">
          <div
            ref={cardRef}
            className="bg-white w-full max-w-5xl rounded-xl shadow-md p-6 md:p-10 mx-auto text-center"
          >
            <p className="text-[#00334E] md:text-[24px] text-[16px] font-semibold font-archivo">
              All cancelations and refunds on deposits and payment can be made
              but must be made by a minimum of 30 days prior to the event.
              Any deposits or payment made within 30 days on the services and
              products provided will be a final sale.
            </p>
          </div>
        </div>
      </section>
